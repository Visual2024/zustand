...
import { useBearsStore, usePersonStore } from '../../store';

export const Dashboard = () => {

  const totalBears = useBearsStore(state => state.computer.totalBears);
  const persona = usePersonStore(state => state.name);
